...
const OrderSchema = new mongoose.Schema(
  {
    ...
    pickupWindowId: { type: mongoose.Schema.Types.ObjectId, ref: 'PickupWindow', required: true, index: true },
    ...
    status:       { type: String, enum: ['CONFIRMED','IN_PREP','READY','PICKED_UP','CANCELLED'], default: 'CONFIRMED', index: true },
